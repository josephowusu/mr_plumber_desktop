class ProductStockComponent extends HTMLElement {
                    ...
                    <div class="container-fluid py-1 px-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                                ...
                                <li class="breadcrumb-item text-sm active" aria-current="page" style="font-family: monRegular !important; color: #0275d8">Product Stock History</li>
                            </ol>
                            <h6 class="font-weight-bolder mb-0" style="font-family: monRegular !important; font-size: 14pt">Product Stock History</h6>
                        </nav>
                                        ...
                                        <table class="table align-items-center mb-0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-uppercase text-secondary font-weight-bolder opacity-7 ps-2" style="font-family: monRegular !important; font-size: 8pt">Supplier</th>
                                                    <th class="text-uppercase text-secondary font-weight-bolder opacity-7 ps-2" style="font-family: monRegular !important; font-size: 8pt">Purchase Price</th>
                                                    <th class="text-uppercase text-secondary font-weight-bolder opacity-7 ps-2" style="font-family: monRegular !important; font-size: 8pt">Value of Stock</th>
                                                    <th class="text-uppercase text-secondary font-weight-bolder opacity-7" style="font-family: monRegular !important; font-size: 8pt">Date</th>
    ...
    //     try {
    //         const stockData = await fetchProductStockById(stockID)
                ...
                for (let i = 0; i < data.data.length; i++) {
                    ...
                    html += String.raw`
                        <tr>
                            ...
                            <td style="font-family: monRegular !important; font-size: 8pt; color: #000">${stock.supplier}</td>
                            <td style="font-family: monRegular !important; font-size: 8pt; color: #000">${stock.purchasePrice}</td>
                            <td style="font-family: monRegular !important; font-size: 8pt; color: #000">${Number(stock.purchasePrice || 0) * Number(stock.quantity)}</td>
                            <td style="font-family: monRegular !important; font-size: 8pt; color: #000">${stock.createdAt}</td>
                            <td class="text-right">

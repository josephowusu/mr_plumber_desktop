class ProductListComponent extends HTMLElement {
    ...
    #__init__() {
        ...
        template.innerHTML = (String.raw`
            ...
            <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg" style="margin-left: 17.125rem;">
                    ...
                    <div class="container-fluid py-1 px-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                                ...
                                <li class="breadcrumb-item text-sm active" aria-current="page" style="font-family: monRegular !important; color: #0275d8">Product List</li>
                            </ol>
                            <h6 class="font-weight-bolder mb-0" style="font-family: monRegular !important; font-size: 14pt">Product List</h6>
                        </nav>
                ...
                <div class="modal fade mt-5" id="productListModal" tabindex="-1" style="display: none;" aria-hidden="true">
    ...
    async #_editProduct(productID) {
        try {
            ...
            if (data.success) {
                const { name, description, productCategoryID } = data.data
